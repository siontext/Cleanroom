...
class MembersGetProfileResponseDtoTest {
    ...
    void testConstructorWithValidMembers() {
        ...
        // when: MembersGetProfileResponseDto 객체를 생성
        MembersGetProfileResponseDto responseDto = new MembersGetProfileResponseDto(members);
